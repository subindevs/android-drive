...
import me.proton.android.drive.ui.viewmodel.ShareExternalInvitationOptionsViewModel
import me.proton.core.compose.component.bottomsheet.RunAction
import me.proton.core.drive.drivelink.shared.presentation.component.ShareUserOptions

@Composable
fun ShareExternalInvitationOptions(
    runAction: RunAction,
...
@Composable
fun ShareExternalInvitationOptions(
    viewModel: ShareExternalInvitationOptionsViewModel,
    runAction: RunAction,
    modifier: Modifier = Modifier,
) {
...
object ExternalInvitationOptionsDialogTestTag {
    const val contextMenu = "external invitation options context menu"
}
